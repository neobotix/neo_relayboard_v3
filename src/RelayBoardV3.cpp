...
template<class T>
void RelayBoardV3::bulk_subscribe(std::function<void(const typename T::ConstPtr&, vnx::TopicPtr)> func, const std::map<std::string, vnx::TopicPtr> mapping){
...
template<class T>
void RelayBoardV3::publish_to_ros(boost::shared_ptr<T> sample, const std::string &ros_topic){
...
template<class T>
void RelayBoardV3::publish_to_ros(boost::shared_ptr<T> sample, vnx::TopicPtr pilot_topic){
