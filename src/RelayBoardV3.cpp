...
void RelayBoardV3::main(){
    ...
    nh->advertiseService("set_relay", &RelayBoardV3::service_set_relay, this);
    nh->advertiseService("ioboard/set_digital_output", &RelayBoardV3::service_set_digital_output, this);
    nh->advertiseService("start_charging", &RelayBoardV3::service_start_charging, this);
    nh->advertiseService("stop_charging", &RelayBoardV3::service_stop_charging, this);
    nh->advertiseService("shutdown_platform", &RelayBoardV3::service_shutdown_platform, this);
    nh->advertiseService("set_safety_field", &RelayBoardV3::service_set_safety_field, this);
    nh->advertiseService("set_safety_mode", &RelayBoardV3::service_set_safety_mode, this);
    nh->advertiseService("set_leds", &RelayBoardV3::service_set_leds, this);
