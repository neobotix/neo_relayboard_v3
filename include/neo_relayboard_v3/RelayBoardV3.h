...
private:
	...
	rclcpp::Service<neo_srvs2::srv::RelayBoardSetLED>::SharedPtr srv_set_led;
	...
	bool service_set_led(std::shared_ptr<neo_srvs2::srv::RelayBoardSetLED::Request> req, std::shared_ptr<neo_srvs2::srv::RelayBoardSetLED::Response> res);
};
